...
public class AcrModel implements IOverrideModel {
    ...
    public void render(float partialTicks, ItemDisplayContext display, ItemStack stack, ItemStack parent, LivingEntity entity, PoseStack matrix, MultiBufferSource renderingbuffer, int light, int overlay){
        ...
        //So I wanna make the Iron Sights Go Dissapear so in that case imma doing a RenderModel method.In here we use two different models that will render on a stupid gun
