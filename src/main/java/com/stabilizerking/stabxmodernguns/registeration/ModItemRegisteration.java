...
public class ModItemRegisteration {
    ...
    public static final RegistryObject<GunItem> AA12UX = ITEMS.register("aa12ux",
            () -> new GunItem(new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<StockItem> LIGHT_STOCK = ITEMS.register("light_weighted_stock",
